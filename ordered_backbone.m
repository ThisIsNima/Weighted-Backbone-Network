...
for i=1:length(files)
  ...
  data_set{i}=data1.TSData.Region_41.allVoxts;    %for region 41 (change the region number based on your interest)
end
  
%%%%%%%%%%%% create the dynamic network connectivity with given temporal window size

Dynamic_Adjacencies=ST_Preparation(data_set,w_t);
